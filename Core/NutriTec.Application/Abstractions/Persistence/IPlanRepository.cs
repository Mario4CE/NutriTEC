...
public interface IPlanRepository
{
    ...
    Task<IReadOnlyCollection<Plan>> ListarPorNutricionistaAsync(Guid idNutricionista, CancellationToken cancellationToken);
     ...
     * Entradas: Identificadores del plan y del nutricionista, y cancelación.
     * Salidas: Verdadero si el plan existe y pertenece a ese nutricionista.
     * Restricciones: No modifica datos.
     */

    Task<bool> PertenecePlanAAsync(Guid idPlan, Guid idNutricionista, CancellationToken cancellationToken);
}