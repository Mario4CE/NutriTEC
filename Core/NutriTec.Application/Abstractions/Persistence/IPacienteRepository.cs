...
public interface IPacienteRepository
{
     ...
     * Entradas: Identificadores de nutricionista y cliente, y cancelación.
     * Salidas: Existencia de la asociación.
     * Restricciones: No modifica datos.
     */

    Task<bool> ExisteAsociacionAsync(Guid idNutricionista, Guid idPaciente, CancellationToken cancellationToken);
    ...
    Task<IReadOnlyCollection<PacienteNutricionista>> ListarPorNutricionistaAsync(Guid idNutricionista, CancellationToken cancellationToken);
     ...
     * Entradas: Identificadores de nutricionista y paciente, y cancelación.
     * Salidas: Verdadero si el paciente está asociado a ese nutricionista.
     * Restricciones: No modifica datos.
     */

    Task<bool> EsPacienteDeAsync(Guid idNutricionista, Guid idPaciente, CancellationToken cancellationToken);
