...
{
    /* Descripción: Persiste un producto. Entradas: Agregado y cancelación. Salidas: Agregado persistido. Restricciones: Recibe datos validados. */
    Task<Producto> CrearAsync(Producto producto, CancellationToken cancellationToken);

    /* Descripción: Consulta por identificador. Entradas: Identificador y cancelación. Salidas: Producto o nulo. Restricciones: No modifica datos. */
    Task<Producto?> ObtenerPorIdAsync(Guid idProducto, CancellationToken cancellationToken);

    /* Descripción: Lista productos. Entradas: Cancelación. Salidas: Colección de productos. Restricciones: No modifica datos. */
    Task<IReadOnlyCollection<Producto>> ListarAsync(CancellationToken cancellationToken);

    /* Descripción: Busca productos por nombre. Entradas: Criterio y cancelación. Salidas: Coincidencias. Restricciones: No modifica datos. */
    Task<IReadOnlyCollection<Producto>> BuscarPorNombreAsync(string nombre, CancellationToken cancellationToken);

    /* Descripción: Consulta por código de barras. Entradas: Código y cancelación. Salidas: Producto o nulo. Restricciones: No modifica datos. */
    Task<Producto?> ObtenerPorCodigoBarrasAsync(string codigoBarras, CancellationToken cancellationToken);

    /* Descripción: Verifica unicidad de código. Entradas: Código, exclusión opcional y cancelación. Salidas: Existencia. Restricciones: Permite excluir una edición. */
