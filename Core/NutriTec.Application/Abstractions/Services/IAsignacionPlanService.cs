...
public interface IAsignacionPlanService
{
     ...
     * Entradas: Identificador del nutricionista, DTO de asignación y cancelación.
    ...
    Task<AsignacionPlanResponse> AsignarAsync(Guid idNutricionista, AsignarPlanRequest request, CancellationToken cancellationToken);
