...
{
    /* 
     * Descripción: Genera un hash seguro. 
     * Entradas: Contraseña en texto claro. 
     * Salidas: Hash persistible. 
     * Restricciones: No debe devolver la contraseña original. 
     */

    string GenerarHash(string contrasena);

    /*
     * Descripción: Verifica una contraseña. 
     * Entradas: Contraseña en texto claro y hash persistido. 
     * Salidas: Resultado de validación. 
