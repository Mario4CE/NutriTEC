...
public interface IPlanService
{
     ...
     * Entradas: Identificador del nutricionista, DTO de creación y cancelación.
    ...
    Task<PlanResponse> CrearAsync(Guid idNutricionista, CrearPlanRequest request, CancellationToken cancellationToken);
    ...
    Task<IReadOnlyCollection<PlanResponse>> ListarPorNutricionistaAsync(Guid idNutricionista, CancellationToken cancellationToken);

    /*
     * Descripción: Actualiza el nombre y los items de un plan existente.
     * Entradas: Identificador del nutricionista, identificador del plan, DTO de edición y cancelación.
    ...
    Task<bool> ActualizarAsync(Guid idNutricionista, Guid idPlan, ActualizarPlanRequest request, CancellationToken cancellationToken);

    /*
     * Descripción: Elimina un plan de alimentación.
     * Entradas: Identificador del nutricionista, identificador del plan y cancelación.
    ...
    Task<bool> EliminarAsync(Guid idNutricionista, Guid idPlan, CancellationToken cancellationToken);
}